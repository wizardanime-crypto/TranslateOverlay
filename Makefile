...
TranslateOverlay_CFLAGS = -fobjc-arc -Oz -ffunction-sections -fdata-sections -fvisibility=hidden -flto=thin
TranslateOverlay_LDFLAGS = -Wl,-dead_strip -Wl,-dead_strip_dylibs -Wl,-x -flto=thin
